...
class FasilitasHotelController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'foto'=>'required|image|mimes:png,jpg,jpeg|dimensions:min_width=300,min_height=300|between:30,1000',
    ...
    public function update(Request $request, FasilitasHotel $fasilita)
    {
        $request->validate([
            'nama_fasilitas'=>'required|min:3',
            'foto'=>'required|image|mimes:png,jpg,jpeg|dimensions:min_width=500,min_height=300|between:30,1000',
            'deskripsi'=>'required|min:10'
        ]);
    ...
    {
        if ( $fasilita->foto_fasilitaas_hotel ) {
            $file = 'images/fasilitas/'.$fasilita->foto_fasilitaas_hotel;
